...
class Lexer_01 {
    ...
    fun bb_01_ids() {
        ...
        assert(tks.next().let { it is Tk.Id  && it.str == "skip" })
        ...
        assert(tks.next().let { it is Tk.Id  && it.str == "enum" })
    ...
    fun hh_01_inc() {
        ...
        assert(tks.next().let { it is Tk.Num && it.pos.file=="test.atm" && it.pos.lin==1 && it.pos.col==1 && it.str == "1" })
        assert(tks.next().let { it is Tk.Num && it.pos.file=="test.atm" && it.pos.lin==2 && it.pos.col==1 && it.str == "2" })
        ...
        assert(tks.next().let { it is Tk.Id  && it.pos.file=="xxx.atm"  && it.pos.lin==7 && it.pos.col==9 && it.str == "xxx" })
