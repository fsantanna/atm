...
class Exec_99 {
    ...
    fun hi_08_tags_ops() {
        ...
        assert(out == ":x\n" +
                ...
                " |  build/prelude-x.atm : (lin 8, col 17) : error(:error)\n" +
                " v  error : :error\n") { out }
    }
    ...
    fun za_09_assert() {
        ...
        assert(out == " |  anon : (lin 2, col 13) : assert(false,10)\n" +
                " |  build/prelude-x.atm : (lin 42, col 30) : error(:error,msg)\n" +
                " v  error : 10\n") { out }
    }
    @Test
    fun za_10_assert() {
        ...
        assert(out == " |  anon : (lin 2, col 13) : assert(false,tag(:type,[]))\n" +
                " |  build/prelude-x.atm : (lin 41, col 30) : error(msg)\n" +
                " v  error : :type []\n") { out }
    }
    @Test
    fun za_11_assert() {
    ...
    fun fx_02_iter_err() {
        ...
        assert(out.contains(" |  anon : (lin 2, col 23) : to-iter(nil)\n" +
                " |  build/prelude-x.atm : (lin 199, col 28) : error(:error,#['i','n','v','a','l','i','d'...\n" +
    ...
    fun za_05_assert() {
        ...
        assert(out == "10\n" +
                ...
                " |  build/prelude-x.atm : (lin 40, col 30) : error(:error,#['a','s','s','e','r','t','i'...\n" +
    ...
    fun za_07_assert() {
        ...
        assert(out.contains(" |  anon : (lin 3, col 17) : assert(is'([],:bool),#['o','k'])\n" +
                " |  build/prelude-x.atm : (lin 39, col 30) : error(:error,xx-cat-move(xx-cat-move(#[],#...\n" +
